	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h2 class="text-blue h4">STAFF APPROVED LEAVE</h2>
				</div>
				<div class="pb-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h2 class="text-blue h4">HOD APPROVED LEAVE</h2>
				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
						...
						<tbody>
							<tr>
								<?php
								$status = 1;
								$sql = "SELECT tblhodleave.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblhodleave.LeaveType,tblhodleave.PostingDate,tblhodleave.CeoRemarks,tblhodleave.DceoRemarks from tblhodleave join tblemployees on tblhodleave.empid=tblemployees.emp_id where (tblhodleave.CeoRemarks= '$status' AND tblhodleave.DceoRemarks= '$status') order by lid desc";
								$query = mysqli_query($conn, $sql) or die(mysqli_error());
								while ($row = mysqli_fetch_array($query)) {
									?>
									...
									<td>
										<div class="table-actions">
											<a title="VIEW" href="leave_hod_details.php?leaveid=<?php echo $row['lid']; ?>"><i
													class="dw dw-eye" data-color="#265ed7"></i></a>
										</div>
									</td>
								</tr>
