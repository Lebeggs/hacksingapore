...
if (isset($_POST['add_staff'])) {
	...
	if ($count > 0) { ?>
		...
		mysqli_query($conn, "INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,Status, location, Position_Staff) VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$leave_days','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg','$position_staff')         
		") or die(mysqli_error()); ?>
