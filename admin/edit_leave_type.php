									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="leavetype" type="text" class="form-control" required="true"
													autocomplete="off" value="<?php echo $row['LeaveType']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="description" style="height: 5em;"
													...
													type="text"><?php echo $row['Description']; ?></textarea>
											</div>
										</div>
									</div>								
												...
												<tr>
													...
													<td>
														<div class="table-actions">
															<a href="leave_type.php?delete=<?php echo htmlentities($result->id); ?>"
																data-color="#e95959"><i
