    ...
    if ($fromdate > $todate) {
        ...
        if (filter_var($staffEmailId, FILTER_VALIDATE_EMAIL)) {
            ...
            if (filter_var($hEmailId, FILTER_VALIDATE_EMAIL)) {
                $sql = "INSERT INTO tblleave(LeaveType,ToDate,FromDate,RequestedDays,DaysOutstand,Sign,WorkCovered,HodRemarks,IsRead,empid,num_days,PostingDate)	VALUES('$leave_type','$todate','$fromdate', '$requested_days','$leave_days','$signature','$work_cover','$hod_status','$isread','$empid', '$requested_days', '$datePosting')";
