...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>Resona Merchant Bank Leave System</title>
    ...
    if ($fromdate > $todate) {
        ...
        if (filter_var($staffEmailId, FILTER_VALIDATE_EMAIL)) {
            ...
            if (filter_var($hEmailId, FILTER_VALIDATE_EMAIL)) {
                $sql = "INSERT INTO tblhodleave(LeaveType,ToDate,FromDate,RequestedDays,DaysOutstand,Sign,WorkCovered,CeoRemarks,DceoRemarks,IsRead,empid,num_days,PostingDate)	VALUES('$leave_type','$todate','$fromdate', '$requested_days','$leave_days','$signature','$work_cover','$ceo_status', '$dceo_status','$isread','$empid', '$requested_days', '$datePosting')";
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input name="postion" type="text" class="form-control" required="true"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="date_form" name="date_from" type="date" class="form-control"
                                                required="true" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                ...
                                <!-- <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="approved_outstanding" type="text" class="form-control"
                                                required="true" autocomplete="off" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label>Leave Entitlement </label>
                                            <input name="leave_entitled" type="text" class="form-control"
                                                required="true" autocomplete="off" value="">
                                        </div>
                                    </div>
                                </div> -->
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="requested_days" name="requested_days" type="text"
                                                class="form-control" required="true" autocomplete="off" readonly
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="leave_days" name="leave_days" type="text" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="work_cover" name="work_cover" type="text" class="form-control"
                                                required="true" autocomplete="off" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-outline-danger" id="clear">Clear
                                                    Signature</button>
                                            </div>
                                            <br />
