                                            ...
                                            <tr>
                                                <td class="table-plus">
                                                    <div class="name-avatar d-flex align-items-center">
                                                        <div class="avatar mr-2 flex-shrink-0">
                                                            <img src="<?php echo (!empty($row['signature'])) ? '../signature/' . $row['signature'] : '../signature/NO-IMAGE-AVAILABLE.jpg'; ?>"
                                                                class="border-radius-100 shadow" width="100" height="70"
                                                                alt="">
                                                        </div>
                                                        <div class="txt">
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        <a href="signature.php?delete=<?php echo $row['emp_id']; ?>"
                                                            data-color="#e95959"><i
