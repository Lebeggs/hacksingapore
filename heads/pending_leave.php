						...
						<tbody>
							<tr>
								...
								if ($session_position == 'CEO') {
									...
									AND tblhodleave.CEORemarks= '$status' 
									ORDER BY lid DESC
									LIMIT 5;";
									...
									WHERE tblemployees.role = 'HOD' 
									AND tblemployees.SubDepartment = '$session_depart' 
									AND tblhodleave.DceoRemarks= '$status'
									ORDER BY lid DESC
									LIMIT 5;";
								} else {
									$sql = "SELECT 
									...
									AND tblleave.HodRemarks= '$status'
									ORDER BY lid DESC
									LIMIT 5;";
								}
								...
								while ($row = mysqli_fetch_array($query)) {
									...
									<td>
										<div class="table-actions">
											<a title="VIEW"
												href="<?php echo ($session_depart === 'MGMT') ? 'leave_hod_details.php' : 'leave_details.php'; ?>?leaveid=<?php echo htmlentities($row['lid']); ?>">
