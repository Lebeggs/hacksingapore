			...
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$sql = "SELECT * from tblhodleave where empid = '$session_id'";
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status = 1;
						$query = mysqli_query($conn, "select * from tblhodleave where empid = '$session_id' AND CeoRemarks = '$status' AND DceoRemarks = '$status'") or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status = 0;
						$query_pend = mysqli_query($conn, "select * from tblhodleave where empid = '$session_id' AND CeoRemarks = '$status' AND DceoRemarks = '$status'") or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status = 2;
						$query_reject = mysqli_query($conn, "select * from tblhodleave where empid = '$session_id' AND CeoRemarks = '$status' AND DceoRemarks = '$status'") or die(mysqli_error());
							...
							<tr>
								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) { ?>
										...
										<td><?php $stats = $result->CeoRemarks;
										if ($stats == 1) {
											?>
										...
										<td><?php $stats = $result->DceoRemarks;
										if ($stats == 1) {
											?>
												<span style="color: green">Approved</span>
											<?php }
